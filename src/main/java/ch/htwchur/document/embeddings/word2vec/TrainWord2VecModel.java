...
//        String rawSentence = FileUtils.readFileToString(new File(rawSentenceFile), Charsets.UTF_8);
        ...
        WordVectorSerializer.writeWordVectors(vec, "serialied-300-vector-5-5.txt");
